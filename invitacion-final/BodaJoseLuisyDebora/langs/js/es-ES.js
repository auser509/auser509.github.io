...
var lang_titleModalAsistenciaCeremonia = '¿Asistes a la pre-boda?'; // ok
var lang_titleModalAsistenciaFiesta = '¿Asistes a la boda?'; // ok

var lang_titleModalMapaFiesta = 'Cómo llegar a la boda'; // ok
var lang_titleModalMapaCeremonia = 'Cómo llegar a la pre-boda'; // ok

var lang_placeholderFiesta = "¿Vienes acompañado? Indica su nombre"; // modifico 11/03 - Indica algún dato importante. \n Ej: Soy vegano, vegetariano, etc.";
var lang_placeholderCeremonia = "¿Vienes acompañado? Indica su nombre"; // modifico 11/03 - Ingrese algún dato importante";
//
